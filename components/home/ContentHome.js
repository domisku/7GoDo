            ...
            {!session && (
              <Link href="/signin">
                <button
                  ...
                  className="flex items-center justify-center mb-10 w-40 px-4 py-2 bg-red-500 font-medium text-lg rounded-lg text-white hover:opacity-90"
                >
                  Get Started
                </button>
              </Link>
        ...
        <section className="flex items-center justify-center flex-col-reverse lg:flex-row h-full py-24 lg:py-0 lg:h-screen bg-gray-50 space-y-8 space-y-reverse lg:space-x-8">
          <div className="w-5/6 sm:w-4/6 lg:w-2/6">
            ...
            <p className="text-xl w-10/12">
              Save precious minutes of your time by organizing your day with
              7GoDo. Organize your tasks, lists and reminders without breaking a
              sweat. Being productive has never been so simple!
            </p>
          </div>
        ...
        <section className="flex items-center justify-center flex-col lg:flex-row h-full py-24 lg:py-0 lg:h-screen space-y-8 lg:space-x-28">
          ...
          <div className="w-5/6 sm:w-4/6 lg:w-2/6">
            ...
            <p className="text-xl w-10/12">
              ...
              crowd! We value our customers and listen to your feedback to
              improve your experience with 7GoDo.
            </p>
          </div>
        </section>
          ...
          <div className="flex flex-col items-center w-full h-4/5">
            ...
            {!session && (
              <Link href="/signin">
                <button
                  onClick={() => setLoading(true)}
                  className="flex items-center justify-center mb-16 w-40 px-4 py-2 bg-red-500 font-medium text-lg rounded-lg text-white hover:opacity-90"
                >
                  Get Started
                </button>
              </Link>
